...
This project models environmental regulation as a multi-agent reinforcement learning problem, where a government agent learns to set taxes or production quotas to maximise social welfare, while firm agents learn to adapt their production decisions accordingly.
